...
from industry_resource_mapping.data.entities import Article, ArticleProduction, Demand, Job, Precedence, Provider, T_ArticleId, T_DemandId, T_JobId, T_ProviderId
